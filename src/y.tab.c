...
{
  "$end", "error", "$undefined", "OPEN", "CLOSE", "SHOW", "DEPOSIT",
  "SHUTDOWN", "ACCOUNT", "BALANCE", "BANK", "STATEMENT", "ACCOUNTS",
  "CONNECTIONS", "NAME", "FLOAT", "NUM", "END_STATEMENT", "$accept",
...
{
      -1,     2,     3,    15,    -9,    -1,    -1,    12,     5,    -3,
      11,    13,    14,    -1,    -1,    16,   -10,   -10,   -10,    -1,
      -1,    17,    -1,    -1,   -10,   -10,    -1,   -10,   -10,    -1,
     -10,   -10,   -10,   -10
};
...
{
      16,    17,     1,     2,     3,     4,     5,    15,    24,    25,
       8,     9,    18,    20,    27,    28,     6,    30,    31,    19,
      21,    32,    22,    10,    33,    11,    12,    13,    14,     0,
      23,    26,     0,    29
};

static const yytype_int8 yycheck[] =
{
       5,     6,     3,     4,     5,     6,     7,    16,    13,    14,
       8,     8,     0,    16,    19,    20,    17,    22,    23,    14,
       9,    26,     9,     8,    29,    10,    11,    12,    13,    -1,
      16,    15,    -1,    16
};
...
{
       0,     3,     4,     5,     6,     7,    17,    19,     8,     8,
       8,    10,    11,    12,    13,    16,    19,    19,     0,    14,
      16,     9,     9,    16,    19,    19,    15,    19,    19,    16,
      19,    19,    19,    19
};
